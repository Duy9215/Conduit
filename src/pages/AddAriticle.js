  ...
  const handleNewArticle = async (e) => {
    ...
    try {
      if (!title || !description || !body || !tagList) {
        toast.error("Bạn hãy điền đầy đủ thông tin!!!", { autoClose: 2000, position: "top-center" });
        return;
      }
      ...
      toast.success("Bài viết đã được tạo thành công", { autoClose: 1000, position: "top-center" });
      setShowSuccess(true);
